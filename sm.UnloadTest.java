...
public class UnloadTest extends InitTest {
	...
	public void testUnload(String TCID, String TestScenario, String TestType, String messageCode, String clientTxnId,
		...
		Response encryptDataResponse = SpiceMoneyApiMethods.encryptData(ulr.encryptRequestBody());
		...
		Response unloadResponse = SpiceMoneyApiMethods.unload(unloadRequestBody);
